 ...
 */
class SynchronizeFromNotificationHandler implements ActionHandlerInterface
{
    ...
    {
        return $this->syncService->synchronizeFromNotificationHandler($data, $configuration);
